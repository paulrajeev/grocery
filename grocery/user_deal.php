                    ...
                    <div id="body">
                        ...
                        <div class="hero-unit-table">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $cart_table = mysqli_query($conn, "SELECT od.*, p.name FROM order_details od LEFT JOIN tb_deal p ON od.productID = p.productID WHERE od.memberID='$ses_id' AND od.status='Pending' AND p.productID IS NOT NULL") or die(mysqli_error($conn));
                                    ...
                                    while ($cart_row = mysqli_fetch_array($cart_table)) {
                                        ...
                                        <tr>
                                            ...
                                            <td width="100">
                                                <a href="#orderdel<?php echo $order_id; ?>" role="button" data-toggle="modal" class="btn btn-danger">
                                                    <i class="icon-remove icon-large"></i>&nbsp;Remove
                                                </a>
                                            </td>
                                        </tr>
                                        ...
                                        <div id="orderdel<?php echo $order_id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-footer">
                                                <a class="btn btn-danger" href="remove_item.php<?php echo '?id=' . $order_id; ?>">
                        ...
                        if ($cart_count != 0) {
                            ...
                            while ($rows = mysqli_fetch_array($result)) {
                                ?>
                                <center>
                                    <a href="#order" role="button" data-toggle="modal" class="btn btn-success">
                                        <i class="icon-truck icon-large"></i>&nbsp;Order Items?
                                    </a>
                                </center>
                                <div class="pull-right">
                                    <div class="span">
                                        <div class="alert alert-success">
                                            <i class="icon-credit-card icon-large"></i>&nbsp;Total:&nbsp;<?php echo $rows['sum(total)']; ?>
                                        </div>
                                    </div>
                                </div>
                                <?php
                        ...
                        <div id="order" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="alert alert-danger">
                                    By Clicking Yes Icon You Agree to &nbsp;<strong>Confirm the Order &nbsp;</strong>and You will be contacted for payment terms
                                </div>
