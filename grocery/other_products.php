                ...
                <div class="hero-unit-table"> 
                    ...
                    <div id="body">
                        ...
                        <div class="hero-unit-table">
								...
								<a href = "All_Products.php" name = "" class = "btn btn-success">All Products</a> 
								<a href = "Men.php" name = "" class = "btn btn-primary">Men</a> 			
								<a href = "Women.php" name = "" class = "btn btn-info">Women</a> 
								<a href = "Kids.php" name = "" class = "btn btn-danger">Kids</a> 
								<a href = "Shoes.php" name = "" class = "btn btn-primary">Shoes</a>
