...
if (isset($_POST['update'])) {
    ...
    mysqli_query($conn, "update tb_deal set name='$name',description='$description',category='$category',originated='$originated',price='$price',quantity='$quantity' $loc where productID='$get_id'") or die(mysqli_query());
                    ...
                    <div class="col-md-5 well">
                        <div class="hero-unit-table">   
                          <div class="hero-unit-table">   
                            ...
                            $query = mysqli_query($conn, "select * from tb_deal where productID='$get_id'") or die(mysqli_error());
                            ...
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                    <div class="controls">
										...
										<span><a href = "deal.php" class = "btn btn-danger"> Back</a></span>
                                    </div>
                                </div>
                            </form>
