    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Bapujinagar.com&nbsp;Aone Electronics</a>
            </div>
						...
						<div class="hero-unit-table">   
                           <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    $cart_table = mysqli_query($conn, "select  * from order_details where status='Delivered'") or die(mysqli_error());
