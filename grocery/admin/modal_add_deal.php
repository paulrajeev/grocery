                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <div class="alert alert-info"><strong><center> Add Deal </center></strong></div>
                                        </div>
...
//
                                ...
                                mysqli_query($conn, "insert into tb_deal (name,description,category,originated,price,quantity,location)
