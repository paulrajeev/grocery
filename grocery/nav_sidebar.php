<div id="sidebar" class = "pull-left">
                ...
                <a href="https://e Commerce/" class="logo"><img src="images/l2.jpg" alt=""></a>
                <ul>
                    <li class="">
                        <span><a href="index.php" ><i class="icon-home icon-large"></i> Home</a></span>
                    </li>
                    <li>
                        <span><a href="All_Products.php"><i class=" icon-th-large icon-large"></i> Products</a></span>
                    </li>
                    ...
                    <li>
					 ...
					 <li>
					  ...
					  <li>
                        <span><a href="order.php"><i class="icon-shopping-cart icon-large"></i> Login here to Order</a></span>
                    </li>
                </ul>
